...
pub fn strip_arabic_diacritics(text: &str) -> String {
    ...
    for c in text.chars() {
        ...
        if (0x064B..=0x065F).contains(&code)
            ...
            || (0x06D6..=0x06ED).contains(&code) // Uthmani-specific marks
        {
            continue;
        }
    ...
    for chunk in ayahs.chunks(BATCH_SIZE) {
        let texts: Vec<String> = chunk
            ...
            .map(|a| {
                ...
                format!("Quran {} {}:{}: {}", surah_name, a.surah_number, a.ayah_number, text)
            })
            .collect();
...
fn surah_metadata() -> Vec<(i64, &'static str, &'static str, &'static str, &'static str, i64)> {
    vec![
        (1, "الفاتحة", "The Opener", "Al-Fatihah", "Meccan", 7),
        (2, "البقرة", "The Cow", "Al-Baqarah", "Medinan", 286),
        (3, "آل عمران", "Family of Imran", "Ali 'Imran", "Medinan", 200),
        (4, "النساء", "The Women", "An-Nisa", "Medinan", 176),
        (5, "المائدة", "The Table Spread", "Al-Ma'idah", "Medinan", 120),
        ...
        (23, "المؤمنون", "The Believers", "Al-Mu'minun", "Meccan", 118),
        ...
        (60, "الممتحنة", "She That Is to Be Examined", "Al-Mumtahanah", "Medinan", 13),
        (61, "الصف", "The Ranks", "As-Saf", "Medinan", 14),
        (62, "الجمعة", "The Congregation", "Al-Jumu'ah", "Medinan", 11),
        ...
        (70, "المعارج", "The Ascending Stairways", "Al-Ma'arij", "Meccan", 44),
        ...
        (79, "النازعات", "Those Who Drag Forth", "An-Nazi'at", "Meccan", 46),
        ...
        (102, "التكاثر", "The Rivalry in World Increase", "At-Takathur", "Meccan", 8),
        ...
        (107, "الماعون", "The Small Kindnesses", "Al-Ma'un", "Meccan", 7),
