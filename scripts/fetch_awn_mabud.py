...
Usage:
  ...
  python3 scripts/fetch_awn_mabud.py --pages     # headings + all 4665 pages (~8 min)

Outputs:
  data/awn_mabud_headings.json  — book metadata + headings (1885 headings)
...
def fetch_book_metadata():
    ...
    print(f"Fetching book metadata for Awn al-Ma'bud (book_id={BOOK_ID})...")
...
def fetch_all_pages(metadata: dict):
    ...
    print(f"Fetching all {total} pages for Awn al-Ma'bud...")
